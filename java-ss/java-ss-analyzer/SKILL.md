---
name: java-ss-analyzer
description: 分析 Java 单体项目（多模块 Maven/Gradle 结构）的服务架构。
---

# Java Standalone Service Analyzer

分析当前 Java 单体项目代码，生成四份文档。每份文档服务于不同的读者和场景：

| 文件 | 作用 | 参考指南 |
|------|------|---------|
| `docs/{service-name}/overview.md` | 服务名片：职责、模块、技术栈、依赖 | `references/overview-md.md` |
