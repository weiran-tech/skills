...
**数据来源优先级**：`docs/workflow/overview.md` + `docs/workflow/contracts.md` > 代码扫描。docs 存在时不做代码扫描。
...
如果 `docs/workflow/overview.md` 和 `docs/workflow/contracts.md` 存在，从中提取以下项目特有信息：

**从 `docs/workflow/overview.md`**：
- **RPC 框架类型**：从"技术栈"表格的"RPC 框架"行提取（Tesla / Dubbo / gRPC / Feign）
- **api 模块名**：从"模块结构"表格中识别 api 模块

**从 `docs/workflow/contracts.md`**：
...
**从 `docs/workflow/overview.md` 补充**：
