...
| 文件 | 作用 | 参考指南 |
|------|------|---------|
| `docs/overview.md` | 服务名片：职责、模块、技术栈、依赖 | `references/overview-md.md` |
| `docs/business.md` | 业务规则：为什么这么处理 | `references/business-md.md` |
| `docs/contracts.md` | 对外契约：承诺了什么 | `references/contracts-md.md` |
| `docs/flows.md` | 执行链路：怎么流转 | `references/flows-md.md` |
