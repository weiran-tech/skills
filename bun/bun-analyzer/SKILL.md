...
1. **docs/workflow/{service}/overview.md** → 读取 `references/overview-md.md`
2. **docs/workflow/{service}/business.md** → 读取 `references/business-md.md`
3. **docs/workflow/{service}/flows.md** → 读取 `references/flows-md.md`
